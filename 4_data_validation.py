...
FILES = {
    ...
    "transactions": PATH + "recomart_raw_transactions_dec_2025.csv",
}
...
missing_in_raw_products = dfs["transactions"][~dfs["transactions"]["product_id"].isin(dfs["raw_products"]["product_id"])]
integrity["txn_product_fk_raw_products"] = {
    "missing_ref_count": int(len(missing_in_raw_products)),
    "examples": missing_in_raw_products.head(10).to_dict(orient="records"),
}
...
total_duplicates = sum(s["duplicates"]["duplicate_rows"] for s in summary.values())
